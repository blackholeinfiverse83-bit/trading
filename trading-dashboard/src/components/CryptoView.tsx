  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-400">Track and analyze cryptocurrencies with real-time predictions</p>
      </div>
        ...
        <div className="flex gap-4 mb-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-slate-700/50 border-2 border-slate-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500"
            />
          </div>
          {onHorizonChange && (
            <select
              ...
              className="px-4 py-3 bg-slate-700/50 border-2 border-slate-600 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 font-medium"
            >
          ...
          <button
            ...
            className="px-6 py-3 bg-yellow-500 hover:bg-yellow-600 text-white font-semibold rounded-xl transition-all disabled:opacity-50 flex items-center gap-2"
          >
