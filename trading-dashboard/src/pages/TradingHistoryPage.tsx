  ...
  return (
    <Layout>
      <div className="space-y-6">
        <div>
          <h1 className={`text-3xl font-bold ${isLight ? 'text-gray-900' : 'text-white'} mb-2`}>Trading History</h1>
        ...
        {loading ? (
          ...
          <div className={`${isLight ? 'bg-white/50 border border-gray-200/50' : 'bg-slate-800/50 border border-slate-700/50'} rounded-lg overflow-hidden`}>
            <div className={`p-6 ${isLight ? 'border-b border-gray-200 bg-gray-50' : 'border-b border-slate-700'}`}>
              <div className="flex items-center justify-between">
                <h2 className={`text-xl font-semibold ${isLight ? 'text-gray-900' : 'text-white'}`}>Transactions</h2>
          ...
          <div className={`${isLight ? 'bg-white/50 border border-gray-200/50' : 'bg-slate-800/50 border border-slate-700/50'} rounded-lg p-12 text-center`}>
            ...
            <h3 className={`text-xl font-semibold ${isLight ? 'text-gray-900' : 'text-white'} mb-2`}>No Trading History</h3>
            <p className={isLight ? 'text-gray-600' : 'text-gray-400'}>Your trading history will appear here once you make transactions.</p>
          </div>
        )}
      </div>
    </Layout>
